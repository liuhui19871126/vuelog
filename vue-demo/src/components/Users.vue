<template>
  <div>
    ...
    <!-- <ul>
        <li><router-link to="/users/userAdd">新增用户</router-link></li>
        <li><router-link to="/users/userList">用户列表</router-link></li>
    </ul>
    <router-view></router-view>
...
<script>
    export default{
      props:["a","b"],
        ...
        // methods:{
        //     gotoHome(){
        //         this.$router.push({path:'/news',query:{ui:123}})
        //     }
        // }
        // mouted(){
        //   this.data['uid'] = this.$route.param.uid
        // }
    }
</script>